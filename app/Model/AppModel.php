...
class AppModel extends Model {
    ...
    public function construct($conexao = null) {
        if ($conexao == 'default') {
            ...
            $dados['database'] = 'freedomweb';
            $dados['host'] = 'localhost';
            $dados['login'] = 'postgres';
            $dados['password'] = 'freedom';
            $dados['datasource'] = 'Database/Postgres';
